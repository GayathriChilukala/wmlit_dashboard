...
export default function Login() {
  ...
  >
    <Input placeholder='Email Address'  prefix={<MailOutlined className="site-form-item-icon"   />}/>
  </Form.Item>
  ...
  >
   <Input.Password placeholder='Password'  prefix={<LockOutlined className="site-form-item-icon" />}/>
        ...
        <Form.Item>
          ...
          <a className="login-form-forgot" href="http://localhost:3000/user/forget-password" style={{color:'#1890ff'}}>
            Forgot password
          </a>
        </Form.Item>
